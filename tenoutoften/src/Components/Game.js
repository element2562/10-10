    ...
    return (
            <div className="gameCards">
                ...
                <Button id={props.index} onClick={e => {
                    ...
                    api.addGameToLibrary(props.results[e.target.id].id, sessionStorage.getItem("User"), props.results[e.target.id].name, gamePhoto, props.results[e.target.id].summary, gameRating)
                    }}>
                Add</Button>
